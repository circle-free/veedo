    ...
    fallback() external {
        ...
        assembly {
            ...
            function degreeAdjustment(
                ...
                result := sub(
                    sub(compositionPolynomialDegreeBound, 1),
...

            {
                ...
                mstore(0x1000, addmod(point, sub(PRIME, 1), PRIME))
                ...
                mstore(
                    ...
                    addmod(
                        ...
                        sub(
                            PRIME,
                            /*trace_generator^(trace_length - 1)*/
                            mload(0xf60)
                        ),
                        PRIME
                    )
...

            {
                ...
                for {
                    ...
                    mstore(currentPartialProductPtr, mulmod(mload(currentPartialProductPtr), prodInv, PRIME))
                    // Update prodInv to be 1/(d_0 * ... * d_{i-1}) by multiplying by d_i.
                    prodInv := mulmod(prodInv, mload(add(currentPartialProductPtr, productsToValuesOffset)), PRIME)
                }
            }
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform0_a_0*/
                                    mload(0xcc0),
                                    /*intermediate_value/after_lin_transform0_a_0*/
                                    mload(0xcc0),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform0_b_0*/
                                    mload(0xce0),
                                    /*intermediate_value/after_lin_transform0_b_0*/
                                    mload(0xce0),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform1_a_0*/
                                    mload(0xd00),
                                    /*intermediate_value/after_lin_transform1_a_0*/
                                    mload(0xd00),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform1_b_0*/
                                    mload(0xd20),
                                    /*intermediate_value/after_lin_transform1_b_0*/
                                    mload(0xd20),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform2_a_0*/
                                    mload(0xd40),
                                    /*intermediate_value/after_lin_transform2_a_0*/
                                    mload(0xd40),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform2_b_0*/
                                    mload(0xd60),
                                    /*intermediate_value/after_lin_transform2_b_0*/
                                    mload(0xd60),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform3_a_0*/
                                    mload(0xd80),
                                    /*intermediate_value/after_lin_transform3_a_0*/
                                    mload(0xd80),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform3_b_0*/
                                    mload(0xda0),
                                    /*intermediate_value/after_lin_transform3_b_0*/
                                    mload(0xda0),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform4_a_0*/
                                    mload(0xdc0),
                                    /*intermediate_value/after_lin_transform4_a_0*/
                                    mload(0xdc0),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform4_b_0*/
                                    mload(0xde0),
                                    /*intermediate_value/after_lin_transform4_b_0*/
                                    mload(0xde0),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform5_a_0*/
                                    mload(0xe00),
                                    /*intermediate_value/after_lin_transform5_a_0*/
                                    mload(0xe00),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform5_b_0*/
                                    mload(0xe20),
                                    /*intermediate_value/after_lin_transform5_b_0*/
                                    mload(0xe20),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform6_a_0*/
                                    mload(0xe40),
                                    /*intermediate_value/after_lin_transform6_a_0*/
                                    mload(0xe40),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform6_b_0*/
                                    mload(0xe60),
                                    /*intermediate_value/after_lin_transform6_b_0*/
                                    mload(0xe60),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform7_a_0*/
                                    mload(0xe80),
                                    /*intermediate_value/after_lin_transform7_a_0*/
                                    mload(0xe80),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform7_b_0*/
                                    mload(0xea0),
                                    /*intermediate_value/after_lin_transform7_b_0*/
                                    mload(0xea0),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform8_a_0*/
                                    mload(0xec0),
                                    /*intermediate_value/after_lin_transform8_a_0*/
                                    mload(0xec0),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform8_b_0*/
                                    mload(0xee0),
                                    /*intermediate_value/after_lin_transform8_b_0*/
                                    mload(0xee0),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform9_a_0*/
                                    mload(0xf00),
                                    /*intermediate_value/after_lin_transform9_a_0*/
                                    mload(0xf00),
                                    PRIME
...

                {
                    ...
                    let val := addmod(
                        ...
                        sub(
                            ...
                            mulmod(
                                mulmod(
                                    /*intermediate_value/after_lin_transform9_b_0*/
                                    mload(0xf20),
                                    /*intermediate_value/after_lin_transform9_b_0*/
                                    mload(0xf20),
                                    PRIME
