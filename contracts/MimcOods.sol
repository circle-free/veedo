...
contract MimcOods is MemoryMap, StarkParameters {
    ...
    uint256 internal constant BATCH_INVERSE_CHUNK = (2 + N_ROWS_IN_MASK);
    uint256 internal constant BATCH_INVERSE_SIZE = MAX_N_QUERIES * BATCH_INVERSE_CHUNK;
    ...
    fallback() external {
        ...
        assembly {
            ...
            let friQueueEnd := add(
                ...
                mul(
                    /*n_unique_queries*/
                    mload(add(context, 0x120)),
                    0x60
                )
            )
            let
                traceQueryResponses /*traceQueryResponses*/
            := add(context, 0x3d80)

            let
                compositionQueryResponses /*composition_query_responses*/
            := add(context, 0xb580)
            ...
            for {
                ...
                // Mask items for column #0.
                {
                    ...
                    res := add(
                        ...
                        mulmod(
                            mulmod(
                                /*(x - g * z)^(-1)*/
                                mload(add(denominatorsPtr, 0x20)),
                                /*oods_coefficients[1]*/
...

                {
                    ...
                    res := add(
                        ...
                        mulmod(
                            mulmod(
                                /*(x - z^2)^(-1)*/
                                mload(add(denominatorsPtr, 0x40)),
                                /*oods_coefficients[22]*/
                            ...
                            add(
                                ...
                                sub(
                                    PRIME,
                                    /*composition_oods_values[0]*/
                                    mload(add(context, 0x3440))
                                )
                            ),
                            PRIME
                        )
                    ...
                    res := add(
                        ...
                        mulmod(
                            ...
                            add(
                                ...
                                sub(
                                    PRIME,
                                    /*composition_oods_values[1]*/
                                    mload(add(context, 0x3460))
                                )
                            ),
                            PRIME
                        )
                ...
                mstore(
                    add(friQueue, 0x40),
                    /*friInvPoint*/
                    mload(add(denominatorsPtr, 0x60))
                )
    ...
    */
    function oodsPrepareInverses(uint256[] memory context, uint256[] memory batchInverseArray) internal view {
        ...
        assembly {
            ...
            := mload(add(context, 0x2b40))
            let PRIME := 0x30000003000000010000000000000001

            // Prepare expmods for computations of trace generator powers.

            let
                oodsPoint /*oods_point*/
            := mload(add(context, 0x2b60))
            {
                // point = -z.
            ...
            } lt(evalPointsPtr, evalPointsEndPtr) {
            ...
            } gt(currentPartialProductPtr, midPartialProductPtr) {
